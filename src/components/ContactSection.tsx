        ...
        <div className="max-w-3xl mx-auto text-center mb-12 section-content">
          <div className="relative inline-block mb-6">
            ...
            <p className="relative z-10 text-portfolio-light-slate text-lg px-6 py-3 bg-portfolio-light-navy/30 backdrop-blur-sm border border-portfolio-lightest-navy/30 rounded-lg">
              I'm currently looking for opportunities to apply my skills and
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="group">
                <label
                  htmlFor="name"
                  className="block text-portfolio-light-slate mb-1 group-focus-within:text-portfolio-teal transition-colors"
                >
                  Name
                </label>
                <input
          ...
          {[
            {
              ...
              link: "https://www.linkedin.com/in/mohit-vishwakarma-b54a5b233/",
            },
            {
              icon: <Github className="h-6 w-6" />,
              link: "https://github.com/mohitvishwa813",
            },
            {
              icon: <Mail className="h-6 w-6" />,
              link: "mohitvishwa813@gmail.com",
            },
          ].map((social, index) => (
            <a
              key={index}
