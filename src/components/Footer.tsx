      ...
      <div className="container mx-auto px-6">
        <div className="text-center relative">
            ...
            {[
              {
                ...
                url: "https://github.com/mohitvishwa813?tab=repositories",
                label: "GitHub",
              },
              {
                icon: <Linkedin className="h-5 w-5" />,
                url: "https://www.linkedin.com/in/mohit-vishwakarma-b54a5b233/",
                label: "LinkedIn",
              },
              {
                icon: <Mail className="h-5 w-5" />,
                url: "mohitvishwa813@gmail.com",
                label: "Email",
              },
            ].map((social, index) => (
              <a
          ...
          <div className="mt-4 text-xs text-portfolio-slate/60 hover:text-portfolio-slate/90 transition-colors duration-300">
            <p className="bg-clip-text text-transparent bg-gradient-to-r from-portfolio-slate/70 to-portfolio-teal/70 cursor-default">
              Frontend Developer • Full Stack Enthusiast • UI/UX Designer
            </p>
          </div>
        </div>
      </div>
