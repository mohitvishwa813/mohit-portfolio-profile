...
const ProjectsSection = () => {
  ...
  const featuredProjects = [
    {
      ...
      github: "https://github.dev/mohitvishwa813/",
      demo: "#",
    },
    {
  ...
  return (
    <section id="projects" className="bg-portfolio-light-navy/30 px-6 py-24 relative overflow-hidden">
                ...
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/2">
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <Folder className={`h-8 w-8 transition-all duration-300 ${hoveredProject === index ? 'text-portfolio-teal' : 'text-portfolio-teal/70'}`} />
                      <div className="flex space-x-3">
                        {project.github && (
                          <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-portfolio-light-slate hover:text-portfolio-teal transition-colors">
                            <Github className="h-5 w-5" />
                          </a>
                        )}
                        {project.demo && (
                          <a href={project.demo} target="_blank" rel="noopener noreferrer" className="text-portfolio-light-slate hover:text-portfolio-teal transition-colors">
                    ...
                    <div className="flex flex-wrap gap-2 mt-auto">
                      {project.technologies.map((tech, techIndex) => (
                        <span key={techIndex} className="tech-tag text-xs bg-portfolio-navy/50 border border-portfolio-lightest-navy/50 backdrop-blur-sm">
                          {tech}
                        </span>
                      ))}
                    </div>
